...
run_shell_step "29a-product-slice-governance-check" "cd '${REPO_ROOT}' && source .venv/bin/activate && python scripts/kw_product_slice_governance_check.py --repo-root . --require-ready"
...
run_shell_step "29n-professional-quality-evaluator-check" "cd '${REPO_ROOT}' && source .venv/bin/activate && python scripts/kw_professional_quality_evaluator_check.py --repo-root . --require-ready"
