...
REQUIRED_PHRASES = {
    ...
    "backend/tests/services/test_kr7e_offline_evidence_index.py": [
        ...
        "test_kr7e3_persists_and_loads_offline_evidence_index_without_absolute_paths",
        "test_kr7e3_loaded_evidence_index_preserves_unsupported_claim_reports",
    ],
    ...
    "docs/QUALITY_MATRIX.md": [
        ...
        "KR-7E.3 adds evidence index persistence",
    ],
