...
def test_valid_llm_plan_is_used_after_schema_validation() -> None:
    fake_llm = _FakeSlidesPlanner(
        """
        {
          ...
          "slides": [
            {"slide_number": 1, "title": "Цель внедрения", "bullets": ["Сократить ручную работу", "Повысить проверяемость результатов"]},
            {"slide_number": 2, "title": "Текущие проблемы", "bullets": ["Разрозненные файлы и версии", "Сложная проверка источников"]},
            {"slide_number": 3, "title": "Целевая workflow-модель", "bullets": ["Промпт и источники превращаются в план", "Артефакты проходят validation gates"]},
            {"slide_number": 4, "title": "Пилотные сценарии", "bullets": ["DOCX, PDF, XLSX и презентации", "Python-анализ и browser evidence"]},
            {"slide_number": 5, "title": "План внедрения", "bullets": ["Начать с пилота", "Закрепить роли и критерии качества"]},
            {"slide_number": 6, "title": "Ожидаемый эффект", "bullets": ["Быстрее готовить материалы", "Сохранять audit trail"]}
          ]
        }
        """
    )
