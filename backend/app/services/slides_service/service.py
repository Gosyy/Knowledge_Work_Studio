...
from backend.app.services.slides_service.outline import build_slides_outline
...
@dataclass
class SlidesService:
    """Outline-first deterministic slides MVP generator."""
    ...
    def generate_deck(self, source_text: str) -> SlidesTransformOutput:
        ...
        return SlidesTransformOutput(slide_count=slide_count, summary_text=summary_text, artifact_content=artifact_content)
