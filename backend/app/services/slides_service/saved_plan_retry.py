...
def retry_saved_plan_with_lifecycle(
    ...
    *,
    ...
    safe_metadata = {
        ...
        "render_mode_runtime_hardened": render_result.safe_metadata.get("render_mode_runtime_hardened"),
        "template_source": render_result.safe_metadata.get("template_source"),
        "layout_policy": render_result.safe_metadata.get("layout_policy"),
        "template_id_required": render_result.safe_metadata.get("template_id_required"),
        "template_locked": render_result.safe_metadata.get("template_locked"),
        "adaptive_layout_selection_enabled": render_result.safe_metadata.get("adaptive_layout_selection_enabled"),
        "external_template_download_allowed": render_result.safe_metadata.get("external_template_download_allowed"),
        "local_template_registry_enforced": render_result.safe_metadata.get("local_template_registry_enforced"),
