...
from backend.app.api.dependencies import get_app_container, get_app_settings, get_session_task_service
...
def execute_task(
    ...
    executed_task = coordinator.execute_task(task_id, content=execute_request.content)
