...
## Rules for Codex during this phase

For every issue:
- keep patches narrow
- preserve the modular monolith architecture
- do not expose internal browser runtime publicly
- do not dump legacy code blindly
- add or update tests
- state commands run
- state test results
- note unresolved follow-up items explicitly

If an issue becomes too large:
- split it before implementation
- prefer one working vertical slice over a broad partial rewrite
